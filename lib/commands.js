...
module.exports = {
    ...
    issue: ["address", "name|params", "qty", {"units": 1}, {"native-amount": min_per_output}, {"custom-fields": {}}],
    issueFrom: ["from-address", "to-address", "asset|params", "qty", {"units": 1}, {"native-amount": min_per_output}, {"custom-fields": {}}],
    issueMore: ["address", "asset", "qty", {"native-amount": min_per_output}, {"custom-fields": {}}],
    issueMoreFrom: ["from", "to", "asset", "qty", {"native-amount": min_per_output}, {"custom-fields": {}}],
    ...
    sendAsset: ["address", "asset", "qty", {"native-amount": min_per_output}, {"comment": null}, {"comment-to": null}],
    sendAssetFrom: ["from-address", "to-address", "asset", "qty", {"native-amount": min_per_output}, {"comment": null}, {"comment-to": null}],
